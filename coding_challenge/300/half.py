...
def half_life(gamma, p):
    ...
    @qml.qnode(dev)
    def noise(
        gamma, p # add optional parameters, delete if you don't need any
    ):
        ...
        """
        qml.GeneralizedAmplitudeDamping(gamma*0.0001, p, wires=[0])
        return qml.density_matrix([0])
        # if qml.density_matrix([0])[1,1] == 0.25:
        #     return N
        # else:
        #     N += 1
        #     print(N)
        #     qml.GeneralizedAmplitudeDamping(gamma*0.2, p)
